...
const SearchSection = React.lazy(
    () => import('@/pages/client/home/components/Hero/SearchSection')
)
const FeaturedBooksCarousel = React.lazy(
    () => import('@/pages/client/home/components/Hero/FeaturedBooksCarousel')
)
const QuickCategories = React.lazy(
    () => import('@/pages/client/home/components/Hero/QuickCategories')
)
